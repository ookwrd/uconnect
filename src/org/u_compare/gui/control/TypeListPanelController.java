...
/**
 * Controller for a TypelistPanel (which represents either an Input or Output
...
public class TypeListPanelController {
	...
	public TypeListPanelController(
			ComponentController parentComponentController, Component component,
			LIST_TYPES outputs) {
	...
	public void addAnnotation() {
		AnnotationTypeOrFeature newType = WorkflowViewerController.typeChooser
				.getNewAnnotation();
