...
/**
 * GUI Component containing the WorkflowPane/WorkflowViewer on the left and the
 * Library on the right separated by a splitPane.
 * 
 * @author luke
 * @author pontus
 * @version 2010-12-04
...
public class UConnectVerticalSplitPane extends JSplitPane {
	...
	/**
	 * @param workflow
	 *            Either a workflowPane or WorkflowViewer depending on whether
	 *            the current configuration allows multiple workflow tabs.
	 * @param libraryPane
	 */
	public UConnectVerticalSplitPane(JComponent workflow, JComponent libraryPane) {
		...
		// Override the paint method of the divider bar so that it doesn't
		// paint.
	...
	public void setPreferredSize(Dimension d) {
		...
		setDividerLocation(UConnectVerticalSplitPane.DIVIDER_START_POSITION);
	}
