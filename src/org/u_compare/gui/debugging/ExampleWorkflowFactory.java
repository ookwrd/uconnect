...
public class ExampleWorkflowFactory {
	...
	public static Workflow simpleWithParameters(){
		...
		c3params.add(new BooleanParameter("bool1","A true boolean",
				false, true));
		c3params.add(new BooleanParameter("bool2","A false boolean",
				false, false));
	...
	public static Workflow deepAggregate(int depth, int branchingfactor){
		...
		ArrayList<AggregateComponent> bottomLevel =
			new ArrayList<AggregateComponent>();
		bottomLevel.add(workflow);
		ArrayList<AggregateComponent> nextLevel =
			new ArrayList<AggregateComponent>();
	...
	public static Workflow cpeWorkflow(){
		return Workflow.constructWorkflowFromXML(
				"src/org/u_compare/gui/model/uima/debugging/CPEimport.xml");
	}
	
	public static Workflow cpeWorkflowDirect(){
		return Workflow.constructWorkflowFromXML(
				"src/org/u_compare/gui/model/uima/debugging/CPEdirect.xml");
	}
