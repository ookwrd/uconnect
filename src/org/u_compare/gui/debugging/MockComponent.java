...
public class MockComponent extends AbstractComponent implements Component {
	...
	public MockComponent() {
		...
		params.add(new BooleanParameter("Boolean",
				"This is a boolean configuration Parameter", false, false));
		setConfigurationParameters(params);
	}

	/**
	 * Construct new placeholder component with a list of configuration
	 * Parameters
	 */
	...
	/**
	 * Construct new placeholder component and assign an identifier for testing
	 * purposes.
	 * 
	 * @param identifier
	 */
