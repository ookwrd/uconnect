...
public class ComponentControllerTester {
	...
	@Test
	public void checkParentage() throws IllegalAccessException,
			NoSuchFieldException {
		assertTrue(PrivilegedAccessor.getValue(control, "parent") == null);
		ComponentController child = ((ArrayList<ComponentController>) PrivilegedAccessor
				.getValue(control, "subControllers")).get(0);
		assertTrue(PrivilegedAccessor.getValue(child, "parent").equals(control));
	}

	@Test
	public void simpleAdd() throws IllegalAccessException,
			NoSuchFieldException, InvalidSubComponentException {
		control.addSubComponent(controller, 0);
		assertTrue(((ArrayList<ComponentController>) PrivilegedAccessor
				.getValue(control, "subControllers")).contains(controller));
	}

	@Test
	public void simpleAdd1() throws InvalidSubComponentException,
			IllegalAccessException, NoSuchFieldException {
		control.addSubComponent(controllerAggregate, 0);
		assertTrue(((ArrayList<ComponentController>) PrivilegedAccessor
				.getValue(control, "subControllers"))
				.contains(controllerAggregate));
	}
	...
	@Test
	public void canRemoveNonEditable() throws IllegalAccessException,
			NoSuchFieldException {
	...
	@Test(expected = InvalidSubComponentException.class)
	public void moveFromUneditable() throws IllegalAccessException,
			NoSuchFieldException, InvalidSubComponentException {
		control.setLocked(true);
		ComponentController child = ((ArrayList<ComponentController>) PrivilegedAccessor
				.getValue(control, "subControllers")).get(0);
	...
	@Test
	public void parentsAdjusted() throws IllegalAccessException,
			NoSuchFieldException, InvalidSubComponentException {
		ComponentController child = ((ArrayList<ComponentController>) PrivilegedAccessor
				.getValue(control, "subControllers")).get(0);
		controllerAggregate.addSubComponent(child, 0);
		assertTrue(PrivilegedAccessor.getValue(child, "parent").equals(
				controllerAggregate));
	}
	...
	public void remove() throws IllegalAccessException, NoSuchFieldException {
		ComponentController child = ((ArrayList<ComponentController>) PrivilegedAccessor
				.getValue(control, "subControllers")).get(0);
		assertTrue(((ArrayList<ComponentController>) PrivilegedAccessor
				.getValue(control, "subControllers")).contains(child));
		control.removeSubComponent(child);
		assertFalse(((ArrayList<ComponentController>) PrivilegedAccessor
				.getValue(control, "subControllers")).contains(child));
	}
	...
	@Test
	public void objectsAdjusted() throws IllegalAccessException,
			NoSuchFieldException, InvalidSubComponentException {
		ComponentController child = ((ArrayList<ComponentController>) PrivilegedAccessor
				.getValue(control, "subControllers")).get(0);
		child.removeComponent();
		...
		System.out.println(((ArrayList<ComponentController>) PrivilegedAccessor
				.getValue(controllerAggregate, "subControllers")).size());
		controllerAggregate.addSubComponent(child, 0);
		assertFalse(((ArrayList<ComponentController>) PrivilegedAccessor
				.getValue(control, "subControllers")).contains(child));
		assertTrue(((ArrayList<ComponentController>) PrivilegedAccessor
				.getValue(controllerAggregate, "subControllers"))
				.contains(child));
		...
		System.out.println(((ArrayList<ComponentController>) PrivilegedAccessor
				.getValue(controllerAggregate, "subControllers")).size());
		assertTrue(((ArrayList<ComponentController>) PrivilegedAccessor
				.getValue(controllerAggregate, "subControllers")).size() == 1);
	}
