...
public class RunTester {
	...
	public RunTester(String location) throws ResourceInitializationException {
		...
		AnalysisEngine ae = UIMAFramework.produceAnalysisEngine(component
		...
		try {
			System.out.println("Trying " + UIMAComponentTester.flags[0] + " "
					+ UIMAComponentTester.flags[1]);
			ae.process(jcas);
			System.out.println("Done " + UIMAComponentTester.flags[0] + " "
					+ UIMAComponentTester.flags[1]);
	...
	public static void main(String[] args) {
		try {
			new RunTester(
					"src/org/u_compare/gui/model/uima/debugging/AggregateAEWithChildren.xml");
