...
public class BooleanParameter extends AbstractParameter<Boolean> {
	...
	public BooleanParameter(String name, String description, boolean mandatory,
			Boolean parameter) {
	...
	public void setValues(String[] input) throws ConstraintFailedException {
		...
		for (String string : input) {
			// TODO add a constraint of type isBoolean to the inputs...
			// parseBoolean parses any string as false.
