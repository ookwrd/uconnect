...
public interface AggregateComponent extends Component {
	 ...
	 * 
	 * Components already at positions >= position will be shifted along to make
	 * room. If the specified component is already a direct subcomponent of this
	 * aggregate {@link #reorderSubComponent(int, Component)} should be used
	 * instead.
	 * 
	 * @param position
	 *            Position at which to add the subcomponent.
	 * @param component
	...
	/**
	 * Validates whether the specified subcomponent can be added at the
	 * specified position.
	 * 
	 * If the specified component is already a direct subcomponent of this
	 * aggregate {@link #canReorderSubComponent(int, Component)} should be used
	 * instead.
	 * 
	...
	/**
	 * Validates whether the specified subcomponent can be added at an
	...
	/**
	 * Validates whether the specified subcomponent can be removed from this
	 * aggregate.
	 * 
	 ...
	 * 
	 * @param components
	 *            The list of subcomponents to replace existing subcomponents
	 *            with.
	 */
	public void setSubComponents(ArrayList<Component> components);

	/**
	 * Validates whether the existing subcomponents can be replaced by the
	 * specified set.
	 * 
	 * Use {@link #setSubComponents(ArrayList)} to actually perform the
	 * replacement.
	 * 
	 * @param components
	 *            Set of Components to replace with.
	...
	/**
	 * Reorders the specified component to the specified position in this
	 * aggregates subcomponents list.
	 * 
	 * @param component
	 *            The component to reorder.
	 * @param position
	 *            The position to be reordered to.
	 * @throws InvalidPositionException
	 *             Thrown when adding to a position outside 0<x<size.
	 */
	public void reorderSubComponent(Component component, int position)
			throws InvalidPositionException;

	/**
	 * Verifies whether the specified component can be relocated to the
	 * specified position in this components subcomponents list.
	 * 
	 * Use {@link #reorderSubComponent(Component, int)} to actually perform
	 * reordering.
	 * 
	 * @param component
	 *            The component to reorder.
	...
	/**
	 * Register a listener to be notified whenever this aggregates subcomponent
	 * list changes.
	 * 
	 * @param listener
