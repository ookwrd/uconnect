...
/**
 * Constraint class for expressing several common constraint types on individual
 * integers.
 * 
 * @author Luke McCrohon
 * 
 */
public class IntegerConstraint extends
		AbstractWhitelistBlacklistConstraint<Integer> {
