...
public class WorkflowTester {
	...
	public void simpleWorkflowConstruction() {
		...
		assertTrue(((MockComponent) testWorkflow.getSubComponents().get(0))
				.getIdentifier().equals("a"));
		assertTrue(((MockComponent) testWorkflow.getSubComponents().get(1))
				.getIdentifier().equals("b"));
		assertTrue(((MockComponent) testWorkflow.getSubComponents().get(2))
				.getIdentifier().equals("c"));
	}
	...
	public void finalInsertion() throws InvalidPositionException {
		...
		assertTrue(((MockComponent) testWorkflow.getSubComponents().get(2))
				.getIdentifier().equals("c"));
		assertTrue(((MockComponent) testWorkflow.getSubComponents().get(3))
				.getIdentifier().equals("X"));
	}
	...
	@Test
	public void testListeners() throws IllegalArgumentException,
		...
		PrivilegedAccessor.invokeMethod(testWorkflow, "setStatus",
	...
	private static class TestListener1 implements DescriptionChangeListener,
			InputOutputChangeListener, SubComponentsChangedListener,
			SavedStatusChangeListener, MinimizedStatusChangeListener,
	...
	@Test
	public void superComponentsSimpleOperations()
